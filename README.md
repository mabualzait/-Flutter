...
## تنزيل البرامج الاساسية للعمل على Flutter

* [تنزيل Flutter](https://flutter.dev/docs/get-started/install)
* [Git لل Windows](https://git-scm.com/download/win)
* [تنزيل Android Studio](https://developer.android.com/studio/)
* [iOS تعليمات خاصة](https://flutter.dev/docs/get-started/install/macos#ios-setup)
